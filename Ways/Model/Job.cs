...
namespace Ways.Model
{
    class Job
    {
        ...
        public static void AddJob(List<Job> jobs)
        {
            ...
            List<string> LstTechGestMaintInfoSkills = new List<string>();
            LstTechGestMaintInfoSkills.Add("polyvalence");
            LstTechGestMaintInfoSkills.Add("professionnalisme");
            LstTechGestMaintInfoSkills.Add("efficacité");
            LstTechGestMaintInfoSkills.Add("sang-froid");
            LstTechGestMaintInfoSkills.Add("réactivité");
            LstTechGestMaintInfoSkills.Add("patience");
            LstTechGestMaintInfoSkills.Add("pédagogie");
            LstTechGestMaintInfoSkills.Add("veille");
            LstTechGestMaintInfoSkills.Add("rigueur");
            LstTechGestMaintInfoSkills.Add("disponibilité");
            ...
            Job jobTechGestMaintInfo = new Job("Technicien / Gestionnaire maintenance informatique", "Intervenant généralement dans l’urgence, le technicien / gestionnaire de maintenance est appelé pour résoudre " +
                ...
                LstTechGestMaintInfoTasks, LstTechGestMaintInfoSkills, 0
                );
            ...
            List<string> LstChefProjInfoSkills = new List<string>();
            LstTechGestMaintInfoSkills.Add("expérience");
            LstTechGestMaintInfoSkills.Add("professionnalisme");
            LstTechGestMaintInfoSkills.Add("pédagogie");
            LstTechGestMaintInfoSkills.Add("assertivité");
            LstTechGestMaintInfoSkills.Add("persuasion");
            LstTechGestMaintInfoSkills.Add("écoute");
            LstTechGestMaintInfoSkills.Add("pragmatisme");
            LstTechGestMaintInfoSkills.Add("anticipation");
            LstTechGestMaintInfoSkills.Add("assurance");
            LstTechGestMaintInfoSkills.Add("leadership");
            ...
            List<string> LstAnalysteProgrammeurSkills = new List<string>();
            LstAnalysteProgrammeurSkills.Add("expérience");
            LstAnalysteProgrammeurSkills.Add("professionnalisme");
            LstAnalysteProgrammeurSkills.Add("pédagogie");
            LstAnalysteProgrammeurSkills.Add("assertivité");
            LstAnalysteProgrammeurSkills.Add("persuasion");
            LstAnalysteProgrammeurSkills.Add("écoute");
            LstAnalysteProgrammeurSkills.Add("pragmatisme");
            LstAnalysteProgrammeurSkills.Add("anticipation");
            LstAnalysteProgrammeurSkills.Add("assurance");
            LstAnalysteProgrammeurSkills.Add("leadership");
            ...
            Job jobAnalysteProgrammeur = new Job("Analyste programmeur",
                ...
                LstAnalysteProgrammeurTasks, LstAnalysteProgrammeurSkills, 0
                );
            ...
            List<string> LstAdminSysResSkills = new List<string>();
            LstAnalysteProgrammeurSkills.Add("expérience");
            LstAnalysteProgrammeurSkills.Add("rigueur");
            LstAnalysteProgrammeurSkills.Add("méthode");
            LstAnalysteProgrammeurSkills.Add("écoute");
            LstAnalysteProgrammeurSkills.Add("vulgarisation");
            LstAnalysteProgrammeurSkills.Add("sang-froid");
            LstAnalysteProgrammeurSkills.Add("relationnel");
            ...
            Job jobAdminSysRes = new Job("Administrateur systèmes & réseaux",
                ...
                LstAdminSysResTasks, LstAdminSysResSkills, 0
                );
            ...
            List<string> LstRespIngLogSkills = new List<string>();
            LstAnalysteProgrammeurSkills.Add("rédactionnel");
            LstAnalysteProgrammeurSkills.Add("créativité");
            LstAnalysteProgrammeurSkills.Add("critique");
            LstAnalysteProgrammeurSkills.Add("coopération");
            LstAnalysteProgrammeurSkills.Add("méthode ");
            LstAnalysteProgrammeurSkills.Add("rigueur");
            LstAnalysteProgrammeurSkills.Add("leadership");
            ...
            Job jobRespIngLog = new Job("Responsable en ingénierie des logiciels",
                ...
                LstRespIngLogTasks, LstRespIngLogSkills, 0
                );
            ...
            List<string> LstArchCloudSkills = new List<string>();
            LstAnalysteProgrammeurSkills.Add("organisation");
            LstAnalysteProgrammeurSkills.Add("coopération");
            LstAnalysteProgrammeurSkills.Add("pédagogie");
            LstAnalysteProgrammeurSkills.Add("polyvalence");
            LstAnalysteProgrammeurSkills.Add("rédactionnel");
            ...
            Job jobArchCloud = new Job("Architect cloud",
                ...
                LstArchCloudTasks, LstArchCloudSkills, 0
                );
            ...
            List<string> LstIngCybersecuSkills = new List<string>();
            LstAnalysteProgrammeurSkills.Add("organisation");
            LstAnalysteProgrammeurSkills.Add("coopération");
            LstAnalysteProgrammeurSkills.Add("pédagogie");
            LstAnalysteProgrammeurSkills.Add("polyvalence");
            ...
            Job jobIngCyber = new Job("Ingénieur en cybersécurité",
                ...
                LstIngCybersecuTasks, LstIngCybersecuSkills, 0
                );
            ...
            List<string> LstDataAnalystSkills = new List<string>();
            LstAnalysteProgrammeurSkills.Add("logique");
            LstAnalysteProgrammeurSkills.Add("anticipation");
            LstAnalysteProgrammeurSkills.Add("veille");
            LstAnalysteProgrammeurSkills.Add("organisation");
            LstAnalysteProgrammeurSkills.Add("rigueur");
            LstAnalysteProgrammeurSkills.Add("précision");
            LstAnalysteProgrammeurSkills.Add("rédactionnel");
            LstAnalysteProgrammeurSkills.Add("professionnel");
            LstAnalysteProgrammeurSkills.Add("éthique");
            ...
            Job jobDataAnalyst = new Job("Data analyst",
                ...
                LstDataAnalystTasks, LstDataAnalystSkills, 0
                );
